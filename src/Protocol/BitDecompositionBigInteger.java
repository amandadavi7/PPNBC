...
public class BitDecompositionBigInteger extends CompositeProtocol implements
    ...
    public BitDecompositionBigInteger(BigInteger input, List<TripleByte> tiShares,
            ...
            int clientId, int prime, int protocolID, int partyCount, int threadID) {
        ...
        // System.out.print("Bit Decomp: Binary version padded: ");
        // for(int i=0; i< temp.size(); i++) {
        //     System.out.print(temp.get(i) + " ");
        // } System.out.println();
    ...
    public int bitMultiplication(int first_bit, int second_bit)
        ...
        MultiplicationByte multiplicationModule
                = new MultiplicationByte(first_bit, second_bit,
                        ...
                        prime, globalPid, asymmetricBit, 1, partyCount, threadID);
        ...
        do {
            ...
            BatchMultiplicationByte batchMultiplication
                    = new BatchMultiplicationByte(
                            ...
                            protocolId, partyCount, threadID);
